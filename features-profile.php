...
if(isset($_POST['update'])){
    ...
    if($_FILES['image']['type']!=""){
      ...
      $check = move_uploaded_file($file_tmp,"assets/img/avatar/".$newname);  //image copy new location
      if($check){
        $profile = "assets/img/avatar/".$newname;
    ...
    $update_query = "UPDATE user_details SET firstname='$name', lastname='$lname', designation='$des', profile='$profile', email='$email', phone='$phone', bio='$bio' WHERE uname='$username';";
                ...
                <div class="row">
                    <div class="column large-12">
                        <h2 class="page-title__large-type">
                            Hi, <?php echo $fname ?>!
                            <span class="page-title__small-type">Change information about yourself on this page.</span>
                        </h2>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="card profile-widget">
                  <div class="profile-widget-header">
                    <img alt="image" src="<?php echo $profile ?>" class="rounded-circle profile-widget-picture">
                  </div>
                  <div class="profile-widget-description">
                    <div class="profile-widget-name"><?php echo $fname ?>
                ...
                <p>
                    <a class="btn btn--stroke u-fullwidth" href="change-password.php">Change Password</a>
                    <a class="btn btn--stroke u-fullwidth" href="logout.php">Log Out</a>
                </p>
        </div>
                ...
                <div class="column lg-6 tab-12">
                    ...
                    <h3 class="u-add-bottom">Edit Profile</h3>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="lg-6 tab-6 mob-12 column">
                          ...
                          <input type="text" name="fname" class="form-control" value="<?php echo $name ?>" required>
                        ...
                        <div class="lg-6 tab-6 mob-12 column">
                          ...
                          <input type="text" name="des" class="form-control" value="<?php echo $des ?>" required>
                      ...
                      <div class="row">
                        <div class="column lg-12">
                          <label>Bio</label>
                          <textarea name="bio" class="u-fullwidth"><?php echo $bio ?></textarea>
                        </div>
                      </div>
                      <p style="color: red;"><?php echo $msg; ?></p>
                      <input  type="submit" name="update" value="Save Changes" class="btn--primary u-fullwidth">
                    </div>
