...
<head>
    ...
    <title>Auth-Profile - MyThing</title>
                ...
                <div class="row">
                    <div class="column large-12">
                        <h2 class="page-title__large-type">
                            Author's Profile
                            <span class="page-title__small-type">All about the author <?php echo $author ?>!</span>
                        </h2>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="card profile-widget">
                  ...
                  <div class="profile-widget-description">
                    <div class="profile-widget-name"><?php echo $author ?>
