...
if(isset($_POST['submit'])){
    ...
    $tags = $_POST['tags'];
        ...
        $sql = "INSERT INTO all_contents(`content_id`, `author`, `category`, `title`, `date`, `picture`, `content`, `highlight`, `tags`, `role`)
        VALUES('','$fname','$cat','$title','$date','','$content','$hcontent','$tags','')";
    ...
    if($_FILES['image']['type']!=""){
        ...
        $imgname = $_FILES['image']['name'];    //temp_name
        $mydate = date('y-m-d-h-i-s');      //for unique name
        $imgname = str_replace(" ","-",$imgname);   //filters
        $newname = $mydate.$imgname;     //random no. //name of your choice (Whatsapp_7686785)
    
    
        $file_tmp = $_FILES['image']['tmp_name'];    //for image copy
    
    
        $check = move_uploaded_file($file_tmp,"images/thumbs/masonry/".$newname);  //image copy new location
        if($check){
          $pic = "images/thumbs/masonry/".$newname;
        } else {
      ...
      $update_query = "UPDATE all_contents SET picture='$pic' WHERE title='$title';";
...
<head>
    ...
    <title>Create Post - MyThing</title>
            ...
            <div class="row s-header__navigation">
                ...
                <nav class="s-header__nav-wrap">
                    ...
                    <ul class="s-header__nav">
                        ...
                        <li class="current-menu-item"><a href="myblog.php" title=""> MyBlogs</a></li>
                ...
                <div class="row">
                    <div class="column large-12">
                        <h2 class="page-title__large-type">
                            Add New Post
                            <span class="page-title__small-type">Create your new post on this page.</span>
                        </h2>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div id="preview"></div>
                            <div class="column lg-12 tab-12">
                                ...
                                <input type="file" name="image" class="form-control" accept="image/*"  id="upload_file" onchange="getImagePreview(event)">
                            </div>
                        </div>
                        <div class="row">
                            <div class="column lg-12 tab-12">
                                <label>Title</label>
                                <input type="text" name="title" class="form-control u-fullwidth" required>
                            </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="column lg-12 tab-12">
                          ...
                          <select name="category" class="u-fullwidth">
                      ...
                      <div class="row">
                        <div class="column lg-12 tab-12">
                          ...
                          <textarea name="content" class="u-fullwidth" maxlength="700" required></textarea>
                        </div>
                      </div>
                      <div class="row">
                        <div class="column lg-12 tab-12">
                          <label>Highlighted Content</label>
                          <textarea  name="hcontent" class="u-fullwidth" maxlength="250" required></textarea>
                        </div>
                      </div>
                        <div class="row">
                            <div class="column lg-12 tab-12">
                                <label>Tags</label>
                                <input type="text" name="tags" class="form-control u-fullwidth" required>
                            </div>
                        </div>
                        <p style="color: red;"><?php echo $msg; ?></p>
                        <input type="submit" name="submit" class="btn--primary u-fullwidth" value="Upload Post">
