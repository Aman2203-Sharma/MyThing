            ...
            <div id="bricks" class="bricks">
                ...
                <div class="masonry">
                    ...
                    <div class="bricks-wrapper" data-animate-block>
                        ...
                        $query = mysqli_query($conn,"SELECT * FROM all_contents WHERE category='$cat' ORDER BY content_id DESC LIMIT {$offset}, {$limit};");
                        if(mysqli_num_rows($query)>0){
                          while($r = mysqli_fetch_assoc($query)){
                        ?>
                ...
                <div class="row pagination">
                    <div class="column lg-12">
                        ...
                        <?php
                            $sql = "SELECT * FROM all_contents WHERE category='$cat';";
                            ...
                            if(mysqli_num_rows($result) > 0){
                                ...
                                if($page > 1){
                                    echo '
                                    <li>
                                        <a class="pgn__prev" href="category.php?page='.($page - 1).'&category='.$cat.'">
                                            <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                for($p = 1; $p <= $total_page; $p++){
                                   ...
                                   echo '<li><a class="pgn__num '.$active.'" href="category.php?page='.$p.'&category='.$cat.'">'.$p.'</a></li>';
                                }
                                if($total_page > $page){
                                echo '
                                <li>
                                    <a class="pgn__next" href="category.php?page='.($page + 1).'&category='.$cat.'">
                                        <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
