...
if (mysqli_num_rows($query) > 0) {
    while ($r = mysqli_fetch_assoc($query)) {
        if ($r['firstname'] . " " . $r['lastname'] == $author) {
            $des = $r['designation'];
            $profile = $r['profile'];
            $bio = $r['bio'];
        }
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO comment_details(comment_id, comment, user, email, date, auth_id, content_id)
        VALUES('','$message','$fname','$adminemail','$date','$adminid','$id')";

    $query = mysqli_query($conn, $sql);

    if ($query) {
        header("Location:single-standard.php?content_id=$id");
    } else {
...
$cnum = "";
$query = mysqli_query($conn, "SELECT * FROM comment_details WHERE content_id=$id");
if (mysqli_num_rows($query) > 0) {
    while ($r = mysqli_fetch_assoc($query)) {
        $cnum = mysqli_num_rows($query);
    }
} else {
    $cnum = '0';
}
...
//       $prev = $id - 1;
//       $next = $id + 1;
//       if($r['content_id'] == $prev){
//         $ptitle = $r['title'];
//       }else if($r['content_id'] == $next){
//         $ntitle = $r['title'];
//       }
//     }
// }

// $sql = mysqli_query($conn, "SELECT * FROM all_contents WHERE content_id = '$prev';");
...
<head>
    ...
    <title>Standard Post - MyThing</title>
            ...
            <div class="s-header__search">
                ...
                <div class="s-header__search-inner">
                    <div class="row">
                        ...
                        <form role="search" method="get" class="s-header__search-form" action="search-result.php?s=<?php if (isset($_GET['s'])) {
                                                                                                                        echo $_GET['s'];
                                                                                                                    } ?>">
                            <label>
                        ...
                        <header class="entry__header">
                            ...
                            <div class="entry__meta">
                                <div class="entry__meta-author">
                                    ...
                                    <a href="auth-profile.php?author=<?php echo $author; ?>"><?php echo $author; ?></a>
                                </div>
                        ...
                        <div class="content-primary">
                            ...
                            <div class="entry__content">
                                ...
                                <div class="entry__author-box">
                                    <figure class="entry__author-avatar">
                                        <img alt="" src="<?php echo $profile; ?>" class="avatar">
                                    </figure>
                                    <div class="entry__author-info">
                                        <h5 class="entry__author-name">
                                            <a href="auth-profile.php?author=<?php echo $author; ?>">
                                                <?php echo $author; ?>
                                            </a>
                                        </h5>
                                        <p>
                            ...
                            <!-- <div class="post-nav">
                                    ...
                                    <div class="post-nav__prev">
                                        <a href="single-standard.php?content_id=<?php
                                                                                //  echo $prev; 
                                                                                ?>" rel="prev">
                                            <span>Prev</span>
                                            <?php
                                    ...
                                    <div class="post-nav__next">
                                        <a href="single-standard.php?content_id=<?php echo $next; ?>" rel="next">
                                            <span>Next</span>
                                            <?php
                                            // echo $ntitle; 
                                            ?>
                                ...
                                <ol class="commentlist">
                                    ...
                                    ?>
                                            ...
                                            <li class="thread-alt depth-1 comment">
                                                ...
                                                <?php
                                                $query1 = mysqli_query($conn, "SELECT * FROM user_details WHERE id=$authid;");
                                                if (mysqli_num_rows($query1) > 0) {
                                                    while ($r = mysqli_fetch_assoc($query1)) {
                                                        $userprofile = $r['profile'];
                                                ?>
                                                        <div class="comment__avatar">
                                                            <img class="avatar" src="<?php echo $userprofile; ?>" alt="" width="50" height="50">
                                                        </div>
                                                <?php
                                                    }
                                                }
                                                ...
                                                <div class="comment__content">
                                                    ...
                                                    <div class="comment__info">
                                                        <div class="comment__author"><?php echo $cname; ?></div>

                                                        <div class="comment__meta">
                                                            <div class="comment__time"><?php echo $cdate; ?></div>
                                                        </div>
                                                    </div>
