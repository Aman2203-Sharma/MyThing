...
if(isset($_POST['update'])){
    ...
    if($_FILES['image']['type']!=""){
      ...
      $update_query = "UPDATE all_contents SET title='$title', picture='$pic', content='$content', highlight='$hcontent', tags='$tags' WHERE content_id='$id';";
                        ...
                        <article class="entry format-standard">
                            ...
                            <div class="row">
                                <div class="column lg-12 tab-12">
                                    <label>Title : </label>
                                    <input type="text" name="title" class="form-control u-fullwidth" value="<?php echo $title ?>" >
                                </div>
                            </div>
                            ...
                            <div class="content-primary">
                                ...
                                <div class="row">
                                    <div class="column lg-12 tab-12">
                                        ...
                                        <textarea name="content" class="u-fullwidth" maxlength="700"><?php echo $content ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="column lg-12 tab-12">
                                        <label>Highlighted Content : </label>
                                        <textarea  name="hcontent" class="u-fullwidth" maxlength="250"><?php echo $hcontent ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                <div class="column lg-12 tab-12">
                                    <label>Tags : </label>
                                    <input type="text" name="tags" class="u-fullwidth" value="<?php echo $tags ?>" >
                                </div>
                            </div>
                        <p style="color: red;"><?php echo $msg; ?></p>
                        <input type="submit" name="update" class="btn--primary u-fullwidth" value="Update">
