            ...
            <div id="bricks" class="bricks">
                ...
                <div class="masonry">
                    ...
                    <div class="bricks-wrapper" data-animate-block>
                        ...
                        <?php
                        $i = 1;
                        $query = mysqli_query($conn,"SELECT * FROM all_contents WHERE author='$fname';");
                        if(mysqli_num_rows($query)>0){
                          while($r = mysqli_fetch_assoc($query)){
                        ?>
                        ...
                        <article class="brick entry" data-animate-el>
                            ...
                            <div class="entry__text">
                                ...
                                <a class="btn" href="edit-post.php?content_id=<?php echo $r['content_id'] ?>">Edit</a>
                                
                            <!-- POST Method -->
                            <form method="post" action="delete-post.php">
                              <input type="hidden" name="id" value="<?php echo $r['content_id'] ?>">
                        ...
                        <article class="brick entry" data-animate-el>
                            ...
                            <div class="entry__thumb">
                                <a href="add-blog.php" class="thumb-link">
                                    <img src="images\thumbs\masonry\add.png" alt="">
                                </a>
                            </div> <!-- end entry__thumb -->
        
                            <div class="entry__text">
                                <div class="entry__header">
                                    <h1 class="entry__title text-center"><a href="add-blog.php">Add New Post</a></h1>
                                 </div>
                            </div> <!-- end entry__text -->
