...
if(isset($_POST['submit'])){
    ...
    if (empty($name) && empty($email) && empty($message)) {
        ...
        $sql = "INSERT INTO message_details(id, name, email, message)
                    ...
                    <article class="entry">
                           ...
                           <header class="entry__header entry__header--narrow">
                            ...
                            <div class="content-primary">
                                    ...
                                    <form class="entry__form" method="post" action="" autocomplete="off">
                                        <fieldset class="row">

                                            <div class="column lg-6 tab-12 form-field">
                                                <input name="name" id="cName" class="u-fullwidth" placeholder="Your Name" value="" type="text">
                                            </div>

                                            <div class="column lg-6 tab-12 form-field">
                                                <input name="email" id="cEmail" class="u-fullwidth" placeholder="Your Email" value="" type="text">
                                            </div>

                                            <div class="column lg-12 message form-field">
                                                <textarea name="msg" id="cMessage" class="u-fullwidth" placeholder="Your Message"></textarea>
                                            </div>

                                            <div class="column lg-12">
                                                <input name="submit" id="submit" class="btn btn--primary btn-wide btn--large u-fullwidth" value="Send Message" type="submit">
                                            </div>
                                ...
                                <div class="entry__content">
                                    <div class="row block-large-1-2 block-tab-whole entry__blocks">
                                        <div class="column">
                                            ...
                                            <p>
                                            aman@mything.com<br>
                                            amansharma888930@gmail.com<br>
                                            Phone: (+91) 7898815124<br>
                                            Gudhiyari, Raipur, CG, 492001, INDIA
                                            
                                            <div class="google-map" data-aos="fade-up" data-aos-delay="900">
                                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14873.170688465138!2d81.62399415!3d21.259879499999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a28ddf639f04cb9%3A0xe0c479fb23fb02c4!2sGudhiyari%2C%20Chhattisgarh!5e0!3m2!1sen!2sin!4v1730546830345!5m2!1sen!2sin" width="920" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </div>
                                            </p>
                                        </div>
                                    </div>
